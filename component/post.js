    ...
    return (
      <div className='flex flex-col flex-wrap h-full w-full md:w-1/2 lg:w-1/3 inline-flex px-4 mb-10'>
        <Link href={'posts/' + id} passHref>
          <Image src={img} height={1080} width={1920} layout={"intrinsic"} alt={''} className='max-w rounded cursor-pointer'/>
        </Link>
    ...
    return (
      <div className='flex flex-col md:flex-row w-full px-4 mb-10'>
        <div className='w-full md:w-4/6'>
          <Link href={'posts/' + id} passHref>
            <Image src={img} height={1080} width={1920} layout={"intrinsic"} alt={''} className='rounded cursor-pointer'/>
          </Link>
        </div>
