        ...
        <div className='flex flex-col flex-1 pr-4'>
          <div className='flex flex-1 justify-between pt-10 gap-6'>
            ...
            <div className='flex flex-col flex-1 min-w-0 gap-2'>
              ...
              <a href={"mailto:justin@nydegger.me"} className='text-md text-gray-500 hover:text-gray-300 transition'>justin@nydegger.me</a>
              <a target={'_blank'} href={'https://x.com/LeJostin'}  className='text-md text-gray-500 hover:text-gray-300 transition'>@LeJostin - x.com</a>
              <a target={'_blank'} href={'https://www.instagram.com/justinnydegger/'} className='text-md text-gray-500 hover:text-gray-300 transition'>@justinnydegger - instagram.com</a>
            </div>
            ...
            <div className='flex flex-col flex-1 min-w-0 gap-2'>
              ...
              <ul className='flex flex-col gap-2'>
                ...
                <li className='text-md text-gray-500'>Apprentice application developer for HEAI - Switzerland (2013 - 2017)</li>
              </ul>
            </div>
